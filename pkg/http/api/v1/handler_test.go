...
func TestRequestHandler_GetMetadata(t *testing.T) {
   ...
   "properties":{
      ...
      "env.SCANNER_VUL_DEBUG_MODE": "true",
      "env.SCANNER_VUL_INSECURE": "true",
      "env.SCANNER_VUL_VULN_TYPE": "os,library",
	  "env.SCANNER_VUL_SECURITY_CHECKS": "vuln",
      "env.SCANNER_VUL_SEVERITY": "UNKNOWN,LOW,MEDIUM,HIGH,CRITICAL",
      "env.SCANNER_VUL_TIMEOUT": "5m0s"
   }
}`,
		},
		{
			name:      "Should respond with a valid Metadata JSON and HTTP 200 OK, when there's no vul Metadata present",
			buildInfo: etc.BuildInfo{Version: "0.1", Commit: "abc", Date: "2019-01-03T13:40"},
			version: vul.VersionInfo{
				Version: "v0.5.2-17-g3c9af62",
			},
   ...
   "properties":{
      ...
      "org.label-schema.version": "0.1",
      "env.SCANNER_VUL_SKIP_UPDATE": "false",
      "env.SCANNER_VUL_OFFLINE_SCAN": "true",
      "env.SCANNER_VUL_IGNORE_UNFIXED": "false",
      "env.SCANNER_VUL_DEBUG_MODE": "false",
      "env.SCANNER_VUL_INSECURE": "false",
      "env.SCANNER_VUL_VULN_TYPE": "os,library",
	  "env.SCANNER_VUL_SECURITY_CHECKS": "vuln",
      "env.SCANNER_VUL_SEVERITY": "UNKNOWN,LOW,MEDIUM,HIGH,CRITICAL",
      "env.SCANNER_VUL_TIMEOUT": "5m0s"
