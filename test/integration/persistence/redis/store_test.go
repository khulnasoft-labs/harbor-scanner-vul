...
import (
	...
	"github.com/khulnasoft-labs/harbor-scanner-vul/pkg/persistence/redis"
	"github.com/khulnasoft-labs/harbor-scanner-vul/pkg/redisx"
...
func TestStore(t *testing.T) {
	...
	config := etc.RedisStore{
		Namespace:  "harbor.scanner.vul:store",
