...
Vul as a plug-in vulnerability scanner in the Harbor registry.
...
1. Generate certificate and private key files:
   ...
   $ openssl req -new -x509 \
       ...
       -out tls.crt \
       -days 365 \
       -subj /CN=harbor-scanner-vul.harbor
   ```
...
| `image.repository`                    | Image name                                                                                                                                                                                                                                                                         | `khulnasoft/harbor-scanner-vul`     |
...
| `scanner.vul.cacheDir`              | Vul cache directory                                                                                                                                                                                                                                                              | `/home/scanner/.cache/vul`       |
| `scanner.vul.reportsDir`            | Vul reports directory                                                                                                                                                                                                                                                            | `/home/scanner/.cache/reports`     |
| `scanner.vul.debugMode`             | The flag to enable or disable Vul debug mode                                                                                                                                                                                                                                     | `false`                            |
| `scanner.vul.vulnType`              | Comma-separated list of vulnerability types. Possible values are `os` and `library`.                                                                                                                                                                                               | `os,library`                       |
| `scanner.vul.ignorepolicy`          | The OPA rego script used by Vul to evaluate each vulnerability                                                                                                                                                                                                                   | `     `                            |
| `scanner.vul.severity`              | Comma-separated list of vulnerabilities severities to be displayed                                                                                                                                                                                                                 | `UNKNOWN,LOW,MEDIUM,HIGH,CRITICAL` |
| `scanner.vul.ignoreUnfixed`         | The flag to display only fixed vulnerabilities                                                                                                                                                                                                                                     | `false`                            |
| `scanner.vul.timeout`               | The duration to wait for scan completion                                                                                                                                                                                                                                           | `5m0s`                             |
| `scanner.vul.skipUpdate`            | The flag to enable or disable Vul DB downloads from GitHub                                                                                                                                                                                                                       | `false`                            |
| `scanner.vul.offlineScan`           | The flag to disable external API requests to identify dependencies                                                                                                                                                                                                                 | `false`                            |
| `scanner.vul.gitHubToken`           | The GitHub access token to download Vul DB                                                                                                                                                                                                                                       |                                    |
| `scanner.vul.insecure`              | The flag to skip verifying registry certificate                                                                                                                                                                                                                                    | `false`                            |
| `scanner.store.redisNamespace`        | The namespace for keys in the Redis store                                                                                                                                                                                                                                          | `harbor.scanner.vul:store`       |
| `scanner.store.redisScanJobTTL`       | The time to live for persisting scan jobs and associated scan reports                                                                                                                                                                                                              | `1h`                               |
| `scanner.jobQueue.redisNamespace`     | The namespace for keys in the scan jobs queue backed by Redis                                                                                                                                                                                                                      | `harbor.scanner.vul:job-queue`   |
